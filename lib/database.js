...
// ─────────────────────────────────────────────────────────────────
// Three affiliate programmes are used — replace IDs with your own:
//
//  1. AMAZON ASSOCIATES — covers all brands without their own Awin
//     programme (Harrows, Unicorn, Mission, Loxley, Shot, Designa,
//     Bulls, One80, Cosmo, Datadart, Cuesoul, Puma, Nodor etc.)
//     Sign up: https://affiliate-program.amazon.co.uk/
//     Replace:  tag=dartfit-21  →  tag=YOUR-AMAZON-ID
//
//  2. TARGET DARTS (Awin Network — merchant ID 7873)
//     Sign up: https://ui.awin.com/merchant-profile/7873
//     Awin auto-appends tracking to target-darts.co.uk deep links.
//
//  3. RED DRAGON DARTS (Awin Network)
//     Sign up: https://ui.awin.com → search "Red Dragon Darts"
//     Awin auto-appends tracking to reddragondarts.com deep links.
//
//  4. WINMAU (Awin Network)
//     Sign up: https://ui.awin.com → search "Winmau"
//     Awin auto-appends tracking to winmau.com deep links.
// ─────────────────────────────────────────────────────────────────
...
const DART_CATALOG = [
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:38.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+ryan+searle+heavy+metal+90&tag=dartfit-21',
  ...
  },
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+dave+chisnall+chizzy+90&tag=dartfit-21',
  ...
  },
  {
    ...
    grip_type:'micro_grip', barrel_shape:'teardrop', balance_point:'front',
    tungsten_pct:85, surface:'natural',
    price_gbp:22.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+quantum+pro&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:95, surface:'natural',
    price_gbp:49.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+atomic+force&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+spina+nero&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:95, surface:'natural',
    price_gbp:54.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+dimension+zero+95&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+phase+5+striker&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'natural',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+ballista+style+1&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    price_gbp:16.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+ballista+style+3&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+contender+90&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:59.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+sigma+pro+95&tag=dartfit-21',
    pro_player:null,
    tags:'95-tungsten,slim,precision,advanced',
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+core+xl+plus&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    tungsten_pct:95, surface:'natural',
    price_gbp:69.99, buy_url:'https://www.amazon.co.uk/s?k=mission+mike+de+decker&tag=dartfit-21',
  ...
  },
  {
    ...
    price_gbp:79.99, buy_url:'https://www.amazon.co.uk/s?k=mission+archon&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    price_gbp:74.99, buy_url:'https://www.amazon.co.uk/s?k=mission+horus&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:38.99, buy_url:'https://www.amazon.co.uk/s?k=mission+komodo+r&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=mission+nightfall&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    price_gbp:33.99, buy_url:'https://www.amazon.co.uk/s?k=mission+crypt&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'natural',
    price_gbp:26.99, buy_url:'https://www.amazon.co.uk/s?k=mission+f300&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'natural',
    price_gbp:31.99, buy_url:'https://www.amazon.co.uk/s?k=mission+saturn+hyperion&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    tungsten_pct:90, surface:'natural',
    price_gbp:28.99, buy_url:'https://www.amazon.co.uk/s?k=loxley+izzy+classic&tag=dartfit-21',
  ...
  },
  {
    ...
    price_gbp:52.99, buy_url:'https://www.amazon.co.uk/s?k=loxley+carbon+6&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'micro_grip', barrel_shape:'teardrop', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=loxley+featherweight&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=loxley+george&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:38.99, buy_url:'https://www.amazon.co.uk/s?k=shot+tribal+weapon+4&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'natural',
    price_gbp:44.99, buy_url:'https://www.amazon.co.uk/s?k=shot+warrior+rutene&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'ringed', barrel_shape:'bomb', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:36.99, buy_url:'https://www.amazon.co.uk/s?k=shot+tribal+weapon+1&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:42.99, buy_url:'https://www.amazon.co.uk/s?k=shot+zen+liang+qing&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:26.99, buy_url:'https://www.amazon.co.uk/s?k=designa+mach+1&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:42.99, buy_url:'https://www.amazon.co.uk/s?k=designa+specialist+95&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=designa+assassin&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=bulls+martin+schindler+g3&tag=dartfit-21',
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:95, surface:'natural',
    price_gbp:47.99, buy_url:'https://www.amazon.co.uk/s?k=bulls+powerflight+95&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:28.99, buy_url:'https://www.amazon.co.uk/s?k=bulls+fortuna+90&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=one80+luxor+gamma&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:90, surface:'natural',
    price_gbp:42.99, buy_url:'https://www.amazon.co.uk/s?k=one80+beau+greaves&tag=dartfit-21',
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=one80+vaelkris&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:44.99, buy_url:'https://www.amazon.co.uk/s?k=one80+signature+fb&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'shark_cut', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=cosmo+fit+point&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=cosmo+discovery&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'shark_cut', barrel_shape:'torpedo', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:27.99, buy_url:'https://www.amazon.co.uk/s?k=datadart+barracuda&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=datadart+dart+devil&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:24.99, buy_url:'https://winmau.com/search?q=simon+whitlock+wizard',
  ...
  },
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:27.99, buy_url:'https://winmau.com/search?q=joe+cullen+road+runner',
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:22.99, buy_url:'https://winmau.com/search?q=james+wade',
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:44.99, buy_url:'https://www.amazon.co.uk/s?k=mission+dimitri+van+den+bergh&tag=dartfit-21',
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=mission+danny+noppert+freeze&tag=dartfit-21',
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=mission+inferno+90&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:44.99, buy_url:'https://www.amazon.co.uk/s?k=mission+pulse+95&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=shot+bandit+95&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=shot+war+machine+5&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=shot+dimplex&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:22.99, buy_url:'https://www.amazon.co.uk/s?k=cuesoul+rost+t20&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=cuesoul+rost+t19&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'micro_grip', barrel_shape:'teardrop', balance_point:'front',
    tungsten_pct:85, surface:'natural',
    price_gbp:17.99, buy_url:'https://www.amazon.co.uk/s?k=cuesoul+king+18g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=one80+gravit-e+23g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'ringed', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:22.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+mystique+22g&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+delf+23g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=designa+mach+5+95&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=designa+maverick+24g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=bulls+highlander+22g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:22.99, buy_url:'https://www.amazon.co.uk/s?k=datadart+raptor+21g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'ringed', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:19.99, buy_url:'https://winmau.com/search?q=blackout+22g',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'micro_grip', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://winmau.com/search?q=stratos+dual+core',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:17.99, buy_url:'https://winmau.com/search?q=artisan+22g',
    pro_player:null,
  ...
  },
  {
    ...
    tungsten_pct:80, surface:'natural',
    price_gbp:9.99, buy_url:'https://winmau.com/search?q=diamond+plus',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:97, surface:'natural',
    price_gbp:27.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+wolfram+97&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'micro_grip', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+supergrip+carbon&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'ringed', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:85, surface:'natural',
    price_gbp:12.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+imperial+24g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:97, surface:'natural',
    price_gbp:44.99, buy_url:'https://www.amazon.co.uk/s?k=mission+axiom+97&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=mission+venom+23g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+maestro+95&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:44.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+t95+core+plus&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:27.99, buy_url:'https://www.amazon.co.uk/s?k=one80+raise+up+22g&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'pvd_coated',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=one80+devils+advocate+24g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=loxley+northern+22g&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:21.99, buy_url:'https://www.amazon.co.uk/s?k=loxley+phoenix+22g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=designa+viper+20g&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'natural',
    price_gbp:22.99, buy_url:'https://www.amazon.co.uk/s?k=designa+hammerhead+26g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=puma+assassin+22g&tag=dartfit-21',
    pro_player:null,
  ...
  },
  {
    ...
    grip_type:'aggressive_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:21.99, buy_url:'https://www.amazon.co.uk/s?k=puma+tyrant+24g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════
  {
    ...
    grip_type:'micro_grip', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=cosmo+fit+point+plus+22g&tag=dartfit-21',
    pro_player:null,
  ...
  // ══════════════════════════════════════════════════════════════════
  // GAP-FILL: BUDGET BOMB-SHAPE (≤£25)
  // Coverage analysis showed 33% of profiles want bomb/pear shape
  // but the cheapest bomb in catalog was £33.99 — critical gap.
  // ══════════════════════════════════════════════════════════════════
  {
    brand:'Winmau', name:'Purist 90% 22g',
    weight:22, length_mm:49, diameter_mm:7.0,
    grip_type:'medium_knurl', barrel_shape:'bomb', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:17.99, buy_url:'https://winmau.com/search?q=purist+22g',
    pro_player:null,
    tags:'bomb,front,budget,pear,22g,value',
    description:'Winmau Purist 90% — classic pear/bomb profile at 22g. The front-heavy bomb shape naturally positions weight ahead of the grip for a smooth forward arc. Outstanding value.',
    released:'2020-03-01',
  },
  {
    brand:'Harrows', name:'Swarm 90% 22g',
    weight:22, length_mm:48, diameter_mm:7.2,
    grip_type:'ringed', barrel_shape:'bomb', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+swarm+90+22g&tag=dartfit-21',
    pro_player:null,
    tags:'bomb,front,ringed,budget,22g,pear',
    description:'Harrows Swarm 90% — ringed-grip bomb barrel at a budget price. The wide front and narrow rear create natural forward momentum. Ideal for players transitioning to front-weighted darts.',
    released:'2021-01-01',
  },
  {
    brand:'Nodor', name:'Supamatch 3 22g',
    weight:22, length_mm:48, diameter_mm:7.5,
    grip_type:'ringed', barrel_shape:'bomb', balance_point:'front',
    tungsten_pct:85, surface:'natural',
    price_gbp:14.99, buy_url:'https://www.amazon.co.uk/s?k=nodor+supamatch+3+22g&tag=dartfit-21',
    pro_player:null,
    tags:'budget,bomb,classic,beginner,ringed,22g,85-tungsten',
    description:"Nodor Supamatch 3 22g — a British darts institution since the 1980s. The classic pear-shaped bomb barrel at budget price. Many players' first tungsten dart. Dependably consistent.",
    released:'2019-01-01',
  },
  {
    brand:'Nodor', name:'Supamatch 3 26g',
    weight:26, length_mm:50, diameter_mm:7.8,
    grip_type:'ringed', barrel_shape:'bomb', balance_point:'front',
    tungsten_pct:85, surface:'natural',
    price_gbp:14.99, buy_url:'https://www.amazon.co.uk/s?k=nodor+supamatch+3+26g&tag=dartfit-21',
    pro_player:null,
    tags:'budget,bomb,heavy,beginner,ringed,26g,85-tungsten',
    description:'Nodor Supamatch 3 26g — the heavy-weight version of the iconic Supamatch. Same classic bomb profile at 26g for players who need extra weight behind their throw.',
    released:'2019-01-01',
  },
  {
    brand:'Designa', name:'Octane 90% 23g',
    weight:23, length_mm:49, diameter_mm:7.1,
    grip_type:'aggressive_knurl', barrel_shape:'bomb', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:22.99, buy_url:'https://www.amazon.co.uk/s?k=designa+octane+23g&tag=dartfit-21',
    pro_player:null,
    tags:'bomb,front,aggressive,23g,budget,90-tungsten',
    description:"Designa Octane 90% — aggressive-knurl bomb at 23g. Designa's budget front-heavy barrel gives powerful throwers a natural forward bias without the premium price tag.",
    released:'2022-04-01',
  },
  {
    brand:'Target', name:'Darts 80% 22g',
    weight:22, length_mm:50, diameter_mm:7.0,
    grip_type:'fine_knurl', barrel_shape:'bomb', balance_point:'front',
    tungsten_pct:80, surface:'natural',
    price_gbp:12.99, buy_url:'https://www.target-darts.co.uk/darts-80',
    pro_player:null,
    tags:'budget,beginner,bomb,80-tungsten,22g,starter,target',
    description:'Target Darts 80% 22g — Target\'s entry-level bomb-shape barrel. 80% tungsten keeps costs low while the classic front-weighted pear profile makes it forgiving for new players.',
    released:'2020-01-01',
  },

  // ══════════════════════════════════════════════════════════════════
  // GAP-FILL: BUDGET SHARK_CUT (≤£25)
  // Cheapest shark_cut was £27.99 — adding the iconic Winmau Shark
  // ══════════════════════════════════════════════════════════════════
  {
    brand:'Winmau', name:'Shark 90% 22g',
    weight:22, length_mm:50, diameter_mm:7.0,
    grip_type:'shark_cut', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:15.99, buy_url:'https://winmau.com/search?q=shark+22g',
    pro_player:null,
    tags:'shark-cut,budget,classic,22g,straight,iconic',
    description:"Winmau Shark 90% — one of darts' most iconic budget barrels, in production since the 1990s. The distinctive shark-cut grooves provide an unmistakable aggressive grip at an unbeatable price.",
    released:'2019-01-01',
  },
  {
    brand:'Winmau', name:'Shark 90% 24g',
    weight:24, length_mm:50, diameter_mm:7.0,
    grip_type:'shark_cut', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:15.99, buy_url:'https://winmau.com/search?q=shark+24g',
    pro_player:null,
    tags:'shark-cut,budget,classic,24g,straight,heavy,iconic',
    description:'Winmau Shark 90% 24g — the heavier sibling of the legendary Shark. All the iconic shark-cut grip with extra mass for players who prefer a 24g throw.',
    released:'2019-01-01',
  },
  {
    brand:'Red Dragon', name:'Sniper 90% 22g',
    weight:22, length_mm:50, diameter_mm:6.6,
    grip_type:'shark_cut', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:24.99, buy_url:'https://www.reddragondarts.com/products/sniper-90',
    pro_player:null,
    tags:'shark-cut,22g,straight,precision,mid-range',
    description:'Red Dragon Sniper 90% — slim 6.6mm shark-cut straight barrel. The aggressive serrated grip bites hard for players who need maximum friction in match pressure situations.',
    released:'2022-01-01',
  },

  // ══════════════════════════════════════════════════════════════════
  // GAP-FILL: SUB-20g LIGHTWEIGHT RANGE
  // Only 4 darts ≤19g in catalog — thin for small hands / light throwers
  // ══════════════════════════════════════════════════════════════════
  {
    brand:'Harrows', name:'Sprint 85% 18g',
    weight:18, length_mm:44, diameter_mm:6.0,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:85, surface:'natural',
    price_gbp:16.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+sprint+18g&tag=dartfit-21',
    pro_player:null,
    tags:'lightweight,18g,small-hands,fine,budget,straight',
    description:'Harrows Sprint 85% 18g — a slim lightweight 18g for players with smaller hands or those who prefer a faster, lighter dart. Compact at 44mm for a more controlled front-grip release.',
    released:'2021-06-01',
  },
  {
    brand:'Target', name:'Carrera 80% 16g',
    weight:16, length_mm:40, diameter_mm:5.8,
    grip_type:'smooth', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:80, surface:'natural',
    price_gbp:12.99, buy_url:'https://www.target-darts.co.uk/carrera-80-16g',
    pro_player:null,
    tags:'ultra-light,16g,beginner,smooth,small-hands,compact',
    description:'Target Carrera 80% 16g — ultra-light 16g for beginners with small hands or youth players. Compact 40mm barrel removes all the clutter and lets a natural throwing motion develop.',
    released:'2020-06-01',
  },
  {
    brand:'Unicorn', name:'Eclipse Pro 80% 19g',
    weight:19, length_mm:46, diameter_mm:6.1,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:80, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+eclipse+pro+19g&tag=dartfit-21',
    pro_player:null,
    tags:'lightweight,19g,budget,fine,beginner-to-intermediate',
    description:'Unicorn Eclipse Pro 80% 19g — lightweight 19g straight barrel from the established Eclipse Pro range. A reliable step up for players moving from brass into budget tungsten.',
    released:'2021-03-01',
  },
  {
    brand:'Winmau', name:'Artisan 90% 20g',
    weight:20, length_mm:47, diameter_mm:6.3,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:17.99, buy_url:'https://winmau.com/search?q=artisan+20g',
    pro_player:null,
    tags:'lightweight,20g,budget,fine,90-tungsten',
    description:'Winmau Artisan 90% 20g — the lighter sibling of the popular Artisan range. 20g straight at £17.99 gives players who want a sub-22g Winmau dart genuine quality without the cost.',
    released:'2020-06-01',
  },
  {
    brand:'Designa', name:'Viper 90% 18g',
    weight:18, length_mm:43, diameter_mm:5.8,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=designa+viper+18g&tag=dartfit-21',
    pro_player:null,
    tags:'ultra-light,18g,slim,straight,90-tungsten,budget',
    description:'Designa Viper 90% 18g — ultra-light 18g at 5.8mm slim diameter. For players with genuinely small hands or those who have tried lighter darts and want to go further.',
    released:'2022-01-01',
  },
];
...
function initSchema(db) {
  ...
  const existingCols = db.prepare('PRAGMA table_info(darts)').all().map(c => c.name);
  if (!existingCols.includes('active'))    db.exec(`ALTER TABLE darts ADD COLUMN active INTEGER DEFAULT 1`);
  if (!existingCols.includes('image_url')) db.exec(`ALTER TABLE darts ADD COLUMN image_url TEXT`);
  ...
  const upsertDart = db.prepare(`
    ...
    ON CONFLICT(brand,name) DO UPDATE SET
      ...
      -- NOTE: image_url intentionally NOT overwritten so cached product images survive reseeds
  `);
