...
const DART_CATALOG = [
  ...
  },
  {
    ...
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+gary+anderson+phase+6+darts&tag=dartfit-21',
    pro_player:'Gary Anderson',
    tags:'anderson,phase6,straight,23g,pendulum',
    description:'Anderson Phase 6 signature — two blue rings at front for his two World Championship wins. 52mm straight barrel for pendulum throwers. Unicorn World Champion range.',
    released:'2023-05-01',
  },
  {
  ...
  // ══════════════════════════════════════════
  // 2026 CATALOG EXPANSION — v2 (40 additions)
  // All buy_urls are Amazon Associates search deep links (tag=dartfit-21)
  // so every link resolves and every click is tracked.
  // ══════════════════════════════════════════
  {
    brand:'Target', name:'RVB95 G2',
    weight:23, length_mm:48, diameter_mm:6.5,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:54.99, buy_url:'https://www.amazon.co.uk/s?k=target+rvb95+g2+van+barneveld+darts&tag=dartfit-21',
    pro_player:'Raymond van Barneveld',
    tags:'95-tungsten,barney,straight,legend',
    description:"Raymond van Barneveld's 95% Generation 2 — precision-milled 48mm straight barrel. Five-time World Champion pedigree in a slim, controlled package.",
    released:'2023-11-01',
  },
  {
    brand:'Target', name:'Sebastian Bialecki G1 SP',
    weight:23, length_mm:51, diameter_mm:6.6,
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'blue_pvd',
    price_gbp:49.99, buy_url:'https://www.amazon.co.uk/s?k=target+sebastian+bialecki+g1+darts&tag=dartfit-21',
    pro_player:'Sebastian Bialecki',
    tags:'90-tungsten,swiss-point,aggressive,young-gun',
    description:"Poland's fast-rising Bialecki signature — aggressive full-length knurl on a 51mm straight barrel with Swiss Point tips.",
    released:'2024-05-01',
  },
  {
    brand:'Target', name:'Cult 01 SP',
    weight:22, length_mm:50, diameter_mm:6.5,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=target+cult+01+swiss+point+darts&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,swiss-point,modern,black-pvd',
    description:'Target Cult 01 — radial-milled grip bands in black PVD with Swiss Point interchangeable tips. A modern all-rounder for middle grippers.',
    released:'2024-08-01',
  },
  {
    brand:'Target', name:'Yohkoh 12',
    weight:21, length_mm:50, diameter_mm:7.3,
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:80, surface:'natural',
    price_gbp:16.99, buy_url:'https://www.amazon.co.uk/s?k=target+yohkoh+darts+21g&tag=dartfit-21',
    pro_player:null,
    tags:'budget,80-tungsten,torpedo,beginner',
    description:'Yohkoh 12 — Target quality at an entry price. Front-loaded torpedo that forgives an inconsistent release while you build your throw.',
    released:'2022-06-01',
  },
  {
    brand:'Target', name:'Crux 03',
    weight:20, length_mm:46, diameter_mm:6.35,
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:32.99, buy_url:'https://www.amazon.co.uk/s?k=target+crux+darts+20g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,compact,fine,versatile',
    description:'Compact 46mm torpedo with clean fine knurl. A nimble 20g for players stepping down in weight without losing barrel presence.',
    released:'2023-04-01',
  },
  {
    brand:'Winmau', name:'Aspria 95/85 Dual Core',
    weight:22, length_mm:49, diameter_mm:6.5,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'front',
    tungsten_pct:95, surface:'natural',
    price_gbp:59.99, buy_url:'https://www.amazon.co.uk/s?k=winmau+aspria+dual+core+darts&tag=dartfit-21',
    pro_player:null,
    tags:'95-tungsten,dual-core,premium,front',
    description:'Aspria Dual Core — 95% tungsten front fused to an 85% rear shifts mass under the fingertips. Winmau flagship engineering for front grippers.',
    released:'2023-03-01',
  },
  {
    brand:'Winmau', name:'Vanguard 22g',
    weight:22, length_mm:48, diameter_mm:6.4,
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:36.99, buy_url:'https://www.amazon.co.uk/s?k=winmau+vanguard+darts+22g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,torpedo,front,clean',
    description:'Vanguard — a progressive front-taper torpedo with precision fine knurl. Rewards a smooth front-pinch release.',
    released:'2022-09-01',
  },
  {
    brand:'Winmau', name:'Firestorm Falcon',
    weight:23, length_mm:51, diameter_mm:6.6,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'red_pvd',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=winmau+firestorm+falcon+darts&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,straight,red-pvd,mid-range',
    description:'Firestorm Falcon — 51mm straight barrel with fire-red PVD grip zones. Dependable centre-balance for rhythm throwers.',
    released:'2023-08-01',
  },
  {
    brand:'Winmau', name:'Navigator 22g',
    weight:22, length_mm:50, diameter_mm:6.5,
    grip_type:'ringed', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:33.99, buy_url:'https://www.amazon.co.uk/s?k=winmau+navigator+darts+22g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,ringed,positional,straight',
    description:'Navigator — deep ring grooves give exact positional feedback so your fingers find the same spot every throw.',
    released:'2022-04-01',
  },
  {
    brand:'Winmau', name:'Overdrive 24g',
    weight:24, length_mm:52, diameter_mm:6.8,
    grip_type:'shark_cut', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'natural',
    price_gbp:35.99, buy_url:'https://www.amazon.co.uk/s?k=winmau+overdrive+darts+24g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,shark,rear,power',
    description:'Overdrive — rear-stacked 24g with shark-cut rear section. Built for power throwers who load from the back of the barrel.',
    released:'2022-11-01',
  },
  {
    brand:'Winmau', name:'Neutron 85% 21g',
    weight:21, length_mm:50, diameter_mm:7.0,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:85, surface:'natural',
    price_gbp:14.99, buy_url:'https://www.amazon.co.uk/s?k=winmau+neutron+darts+21g&tag=dartfit-21',
    pro_player:null,
    tags:'budget,85-tungsten,starter,value',
    description:'Neutron 85% — the classic first "proper" tungsten dart. Honest straight barrel, honest price, a massive step up from brass.',
    released:'2021-01-01',
  },
  {
    brand:'Winmau', name:'Xtreme2 23g',
    weight:23, length_mm:52, diameter_mm:7.6,
    grip_type:'aggressive_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:80, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=winmau+xtreme+darts+23g&tag=dartfit-21',
    pro_player:null,
    tags:'budget,80-tungsten,aggressive,torpedo',
    description:'Xtreme2 — heavy front torpedo with bite. A budget dart that suits strong grips and steep arcs.',
    released:'2021-05-01',
  },
  {
    brand:'Red Dragon', name:'Razor Edge Spectron',
    weight:22, length_mm:50, diameter_mm:6.8,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:85, surface:'multi_pvd',
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=red+dragon+razor+edge+spectron+darts&tag=dartfit-21',
    pro_player:null,
    tags:'85-tungsten,razor-grip,spectrum-coating,value',
    description:'Razor Edge Spectron — laser-cut razor grip under a spectrum PVD finish. Red Dragon\'s proven mid-range workhorse.',
    released:'2022-02-01',
  },
  {
    brand:'Red Dragon', name:'Amberjack Pro 23g',
    weight:23, length_mm:52, diameter_mm:6.6,
    grip_type:'ringed', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=red+dragon+amberjack+pro+darts+23g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,ringed,straight,consistent',
    description:'Amberjack Pro — precision ring-cut 52mm straight barrel. The ringed grip meters finger pressure evenly across the hold.',
    released:'2022-07-01',
  },
  {
    brand:'Red Dragon', name:'Pegasus 20g',
    weight:20, length_mm:45, diameter_mm:6.2,
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:26.99, buy_url:'https://www.amazon.co.uk/s?k=red+dragon+pegasus+darts+20g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,light,slim,front',
    description:'Pegasus — a light, lively 20g front-taper for touch players. Slim 6.2mm profile leaves the treble visible after two darts.',
    released:'2021-09-01',
  },
  {
    brand:'Red Dragon', name:'Javelin Black',
    weight:22, length_mm:47, diameter_mm:6.2,
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:27.99, buy_url:'https://www.amazon.co.uk/s?k=red+dragon+javelin+black+darts&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,black-pvd,torpedo,best-seller',
    description:'Javelin Black — the best-selling Javelin profile in stealth black PVD. Front-weighted flow for pinch grippers.',
    released:'2022-10-01',
  },
  {
    brand:'Red Dragon', name:'Milano RS',
    weight:22, length_mm:50, diameter_mm:6.5,
    grip_type:'micro_grip', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:31.99, buy_url:'https://www.amazon.co.uk/s?k=red+dragon+milano+rs+darts&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,micro,smooth-release,straight',
    description:'Milano RS — micro-cut surface texture that grips on hold and releases clean. For players who hate knurl catching on release.',
    released:'2023-02-01',
  },
  {
    brand:'Red Dragon', name:'Firebird 21g',
    weight:21, length_mm:48, diameter_mm:6.4,
    grip_type:'medium_knurl', barrel_shape:'teardrop', balance_point:'front',
    tungsten_pct:85, surface:'orange_pvd',
    price_gbp:23.99, buy_url:'https://www.amazon.co.uk/s?k=red+dragon+firebird+darts+21g&tag=dartfit-21',
    pro_player:null,
    tags:'85-tungsten,teardrop,front,value',
    description:'Firebird — teardrop mass concentration with flame-orange grip zones. Natural nose-forward flight for arcing throws.',
    released:'2022-05-01',
  },
  {
    brand:'Harrows', name:'Wolfram Infinity 97%',
    weight:22, length_mm:46, diameter_mm:6.0,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:97, surface:'natural',
    price_gbp:64.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+wolfram+infinity+97+darts&tag=dartfit-21',
    pro_player:null,
    tags:'97-tungsten,ultra-slim,elite,flagship',
    description:'Wolfram Infinity — 97% tungsten squeezes 22g into a 6.0mm pencil. The slimmest serious barrel Harrows make; trebles stay open all night.',
    released:'2023-10-01',
  },
  {
    brand:'Harrows', name:'Ice Recut 21g',
    weight:21, length_mm:47, diameter_mm:6.3,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:27.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+ice+recut+darts+21g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,slim,clean,mid-range',
    description:'Ice Recut — clean-cut micro rings on a slim straight barrel. Crisp in the fingers, quiet out of the hand.',
    released:'2022-08-01',
  },
  {
    brand:'Harrows', name:'Supergrip Ultra 23g',
    weight:23, length_mm:51, diameter_mm:6.9,
    grip_type:'ringed', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+supergrip+ultra+darts+23g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,supergrip,ringed,heritage',
    description:'Supergrip Ultra — the legendary Supergrip ring pattern, machined deeper. Four decades of grip heritage in a modern 90% barrel.',
    released:'2021-11-01',
  },
  {
    brand:'Harrows', name:'NX90 Black',
    weight:22, length_mm:50, diameter_mm:6.5,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'black_titanium',
    price_gbp:24.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+nx90+black+darts&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,black-titanium,value,straight',
    description:'NX90 Black — black titanium nitride over a proven straight profile. Strong value at the 90% tier.',
    released:'2022-03-01',
  },
  {
    brand:'Harrows', name:'Noble 24g',
    weight:24, length_mm:53, diameter_mm:6.9,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'gold_pvd',
    price_gbp:31.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+noble+darts+24g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,rear,gold,long-barrel',
    description:'Noble — long 53mm rear-balanced barrel with gold PVD detailing. Room for three fingers and a thumb, built for rear grips.',
    released:'2023-06-01',
  },
  {
    brand:'Harrows', name:'Fire Inferno 23g',
    weight:23, length_mm:50, diameter_mm:6.6,
    grip_type:'aggressive_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'red_pvd',
    price_gbp:33.99, buy_url:'https://www.amazon.co.uk/s?k=harrows+fire+inferno+darts+23g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,aggressive,torpedo,fire-coating',
    description:'Fire Inferno — aggressive cross-cut knurl under flame PVD. Maximum bite for sweaty-hand players and hard snappers.',
    released:'2022-12-01',
  },
  {
    brand:'Unicorn', name:'Gripper 3',
    weight:24, length_mm:51, diameter_mm:6.8,
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+gripper+3+darts+24g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,gripper,aggressive,classic',
    description:'Gripper 3 — Unicorn\'s famous full-grip knurl. If your darts slip, this is the traditional cure.',
    released:'2021-04-01',
  },
  {
    brand:'Unicorn', name:'Core XL Striker 23g',
    weight:23, length_mm:52, diameter_mm:7.5,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:80, surface:'natural',
    price_gbp:17.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+core+xl+striker+darts+23g&tag=dartfit-21',
    pro_player:null,
    tags:'budget,80-tungsten,starter,straight',
    description:'Core XL Striker — a dependable 80% starter barrel from the biggest name in British darts. Ideal first tungsten set.',
    released:'2021-02-01',
  },
  {
    brand:'Unicorn', name:'Maestro Seigo Asada 95%',
    weight:21, length_mm:48, diameter_mm:6.3,
    grip_type:'fine_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:95, surface:'natural',
    price_gbp:49.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+seigo+asada+maestro+darts&tag=dartfit-21',
    pro_player:'Seigo Asada',
    tags:'95-tungsten,japan,precision,front',
    description:"Seigo Asada's Maestro — Japanese precision in a 95% front-taper. 'The Ninja' demands exact repeatability; this barrel delivers it.",
    released:'2023-07-01',
  },
  {
    brand:'Unicorn', name:'T95 Core XL 23g',
    weight:23, length_mm:50, diameter_mm:6.4,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=unicorn+t95+core+xl+darts+23g&tag=dartfit-21',
    pro_player:null,
    tags:'95-tungsten,slim,value-premium,straight',
    description:'T95 Core XL — 95% tungsten at a 90% price point. Slim, honest, and quietly one of Unicorn\'s best value barrels.',
    released:'2022-06-01',
  },
  {
    brand:'Shot', name:'Zen Budo 23g',
    weight:23, length_mm:50, diameter_mm:7.0,
    grip_type:'ringed', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:80, surface:'natural',
    price_gbp:26.99, buy_url:'https://www.amazon.co.uk/s?k=shot+darts+zen+budo+23g&tag=dartfit-21',
    pro_player:null,
    tags:'80-tungsten,nz-made,ringed,zen-series',
    description:'Zen Budo — New Zealand-made with deep ring grip inspired by Japanese craft. Distinctive feel you won\'t find in European barrels.',
    released:'2021-08-01',
  },
  {
    brand:'Shot', name:'Birds of Prey Kite 22g',
    weight:22, length_mm:49, diameter_mm:6.5,
    grip_type:'shark_cut', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'natural',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=shot+darts+birds+of+prey+kite&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,shark,front,nz-made',
    description:'Birds of Prey Kite — talon-inspired shark cuts on a front-weighted torpedo. Shot\'s signature aggressive artistry.',
    released:'2022-09-01',
  },
  {
    brand:'Shot', name:'Michael Smith Bully Boy 90%',
    weight:23, length_mm:50, diameter_mm:6.6,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:44.99, buy_url:'https://www.amazon.co.uk/s?k=shot+michael+smith+bully+boy+darts&tag=dartfit-21',
    pro_player:'Michael Smith',
    tags:'90-tungsten,world-champion,straight,signature',
    description:"Michael Smith's Bully Boy signature — the 2023 World Champion's straight-barrel spec with balanced medium knurl.",
    released:'2023-01-01',
  },
  {
    brand:'Designa', name:'Dark Thunder V2 24g',
    weight:24, length_mm:52, diameter_mm:7.0,
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:22.99, buy_url:'https://www.amazon.co.uk/s?k=designa+dark+thunder+v2+darts+24g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,rear,aggressive,value',
    description:'Dark Thunder V2 — rear-weighted 24g with serious knurl at a price that undercuts everyone. Outstanding value for power throwers.',
    released:'2022-04-01',
  },
  {
    brand:'Designa', name:'Mako 22g',
    weight:22, length_mm:48, diameter_mm:6.6,
    grip_type:'shark_cut', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:85, surface:'natural',
    price_gbp:19.99, buy_url:'https://www.amazon.co.uk/s?k=designa+mako+darts+22g&tag=dartfit-21',
    pro_player:null,
    tags:'85-tungsten,shark,front,budget',
    description:'Mako — shark-cut front torpedo named for its bite. The cheapest way to try shark grip properly.',
    released:'2021-10-01',
  },
  {
    brand:"Bull's", name:'Phantom Grip 23g',
    weight:23, length_mm:51, diameter_mm:6.7,
    grip_type:'micro_grip', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:27.99, buy_url:'https://www.amazon.co.uk/s?k=bulls+phantom+grip+darts+23g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,micro,dutch,smooth-release',
    description:'Phantom Grip — Dutch-engineered micro texture that feels almost smooth until you squeeze. Clean release, zero knurl-catch.',
    released:'2022-08-01',
  },
  {
    brand:'Mission', name:'Ronin RX 22g',
    weight:22, length_mm:48, diameter_mm:6.3,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:95, surface:'natural',
    price_gbp:47.99, buy_url:'https://www.amazon.co.uk/s?k=mission+ronin+rx+darts+22g&tag=dartfit-21',
    pro_player:null,
    tags:'95-tungsten,slim,precision,premium',
    description:'Ronin RX — Mission\'s samurai-precision 95% barrel. Slim 6.3mm with immaculate fine knurl; a premium slim-barrel benchmark.',
    released:'2023-05-01',
  },
  {
    brand:'Mission', name:'Kuro M1 24g',
    weight:24, length_mm:52, diameter_mm:6.9,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'black_pvd',
    price_gbp:36.99, buy_url:'https://www.amazon.co.uk/s?k=mission+kuro+m1+darts+24g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,black,rear,long',
    description:'Kuro M1 — all-black rear-loaded 52mm barrel. Understated looks, deliberate rear-grip engineering.',
    released:'2022-11-01',
  },
  {
    brand:'Mission', name:'Octane 21g',
    weight:21, length_mm:49, diameter_mm:7.2,
    grip_type:'medium_knurl', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:80, surface:'natural',
    price_gbp:15.99, buy_url:'https://www.amazon.co.uk/s?k=mission+octane+darts+21g&tag=dartfit-21',
    pro_player:null,
    tags:'budget,80-tungsten,torpedo,starter',
    description:'Octane — Mission\'s entry 80% torpedo. Forgiving front weight for new players at pocket-money price.',
    released:'2021-06-01',
  },
  {
    brand:'One80', name:'Reflex 22g',
    weight:22, length_mm:50, diameter_mm:6.5,
    grip_type:'fine_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=one80+reflex+darts+22g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,straight,balanced,swiss-brand',
    description:'One80 Reflex — Swiss-brand precision with evenly metered fine knurl. A neutral, honest 22g that suits almost any middle grip.',
    released:'2022-02-01',
  },
  {
    brand:'One80', name:'Jetstream Astra 23g',
    weight:23, length_mm:51, diameter_mm:6.6,
    grip_type:'ringed', barrel_shape:'torpedo', balance_point:'front',
    tungsten_pct:90, surface:'blue_pvd',
    price_gbp:34.99, buy_url:'https://www.amazon.co.uk/s?k=one80+jetstream+astra+darts&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,ringed,front,aero-inspired',
    description:'Jetstream Astra — aero-inspired ringed torpedo in ice-blue PVD. Front CoG with positional ring feedback.',
    released:'2023-03-01',
  },
  {
    brand:'Datadart', name:'Steve West 24g',
    weight:24, length_mm:54, diameter_mm:7.0,
    grip_type:'ringed', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'natural',
    price_gbp:39.99, buy_url:'https://www.amazon.co.uk/s?k=datadart+steve+west+darts&tag=dartfit-21',
    pro_player:'Steve West',
    tags:'90-tungsten,rear,long-barrel,signature',
    description:"Steve West's signature — an unusually long 54mm rear-ringed barrel for his distinctive far-back grip. Rear grippers, this is your reference dart.",
    released:'2022-05-01',
  },
  {
    brand:'Cuesoul', name:'Tero AK5 22g',
    weight:22, length_mm:50, diameter_mm:6.8,
    grip_type:'medium_knurl', barrel_shape:'straight', balance_point:'middle',
    tungsten_pct:90, surface:'natural',
    price_gbp:25.99, buy_url:'https://www.amazon.co.uk/s?k=cuesoul+tero+ak5+darts+22g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,value,integrated-flight-system,straight',
    description:'Tero AK5 — comes with Cuesoul\'s integrated one-piece flight system that never pops out. Clever engineering at a sharp price.',
    released:'2022-10-01',
  },
  {
    brand:'Legend', name:'Pro Series V2 26g',
    weight:26, length_mm:54, diameter_mm:7.4,
    grip_type:'aggressive_knurl', barrel_shape:'straight', balance_point:'rear',
    tungsten_pct:90, surface:'natural',
    price_gbp:29.99, buy_url:'https://www.amazon.co.uk/s?k=legend+darts+pro+series+26g&tag=dartfit-21',
    pro_player:null,
    tags:'90-tungsten,heavy,rear,aggressive',
    description:'Legend Pro Series V2 — a proper heavy 26g with rear stacking and deep knurl. Fills the gap between 24g standards and Searle-class 28g.',
    released:'2023-09-01',
  },
];
...
const PRO_PLAYERS = [
  ...
  {
    id:'smith', name:'Michael Smith', nickname:'Bully Boy',
    country:'England', emoji:'🐂',
    height_cm:175, grip_style:'mid_three_finger', grip_fingers:3,
    preferred_weight:23, preferred_length:50, preferred_grip:'medium_knurl',
    throw_style:'fluid_arc', release_angle:'medium',
    description:"'Bully Boy' Smith throws one of the purest fluid arcs in darts — no pause, no hitch, just rhythm. His balanced 23g straight barrel suits flowing middle-grip players.",
    achievements:'2023 PDC World Champion, 2022 Grand Slam Champion, nine-darter in a World Final',
    dart_name:'Shot Michael Smith Bully Boy 90%',
  },
  {
    id:'barneveld', name:'Raymond van Barneveld', nickname:'Barney',
    country:'Netherlands', emoji:'🦁',
    height_cm:188, grip_style:'front_pinch', grip_fingers:3,
    preferred_weight:23, preferred_length:48, preferred_grip:'fine_knurl',
    throw_style:'smooth_arc', release_angle:'low',
    description:"Five-time World Champion Barney throws from height with a gentle, economical arc and a delicate front pinch. Tall players with soft releases share his biomechanics.",
    achievements:'5x World Champion (4x BDO, 1x PDC), Dutch darts icon',
    dart_name:'Target RVB95 G2',
  },
  {
...
function initSchema(db) {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS profiles (
      ...
      ideal_tungsten_pct INTEGER,
      ideal_shaft_mm INTEGER,
      ideal_flight TEXT,
      archetype_id TEXT,
  ...
  // Migrate: theoretical-perfect-dart columns on profiles (v2.1) — the full
  // ideal spec is stored so new launches can be scored against it forever.
  const profCols = new Set(db.prepare('PRAGMA table_info(profiles)').all().map(c => c.name));
  const addProfCol = (name, ddl) => { if (!profCols.has(name)) db.exec(`ALTER TABLE profiles ADD COLUMN ${ddl}`); };
  addProfCol('ideal_tungsten_pct', 'ideal_tungsten_pct INTEGER');
  addProfCol('ideal_shaft_mm',     'ideal_shaft_mm INTEGER');
  addProfCol('ideal_flight',       'ideal_flight TEXT');
  addProfCol('archetype_id',       'archetype_id TEXT');
  addProfCol('fit_confidence',     'fit_confidence INTEGER');

  // Migrate: users.is_admin — the login route reads it, but the column
  // never existed, so admin access was impossible. Promote via:
  //   UPDATE users SET is_admin = 1 WHERE email = '...'
  const userCols = new Set(db.prepare('PRAGMA table_info(users)').all().map(c => c.name));
  if (!userCols.has('is_admin')) db.exec('ALTER TABLE users ADD COLUMN is_admin INTEGER DEFAULT 0');
